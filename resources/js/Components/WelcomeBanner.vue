    ...
    <template v-if="icon">
      <div class="grid grid-cols-1 md:grid-cols-3 md:items-center w-full gap-4">
        ...
        <div class="ml-6">
          ...
          <BreadCrumbWelcome :resource-title="title" class="mt-2" />
        </div>
        ...
        <div class="flex items-center justify-end gap-x-4 md:mr-14">
          <BaseFormField class="w-32" @change="$emit('applyFilters', true)" type="select" label="Número de preguntas"
...
import BreadCrumbWelcome from './BreadCrumbWelcome.vue';
