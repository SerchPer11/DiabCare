...
export const usePagination = (props) => {
    ...
    const getLinkClasses = (url, label, active) => {
        ...
        if (isPrevious(label) || isNext(label)) {
            return `${baseClasses} text-gray-700 hover:bg-medic-100 hover:text-white border border-gray-300`;
        }

        return `${baseClasses} text-gray-700 hover:bg-medic-100 hover:text-white hover:text-slate-600`;
    };
